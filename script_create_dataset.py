...
import glob
import shutil
from common.util import syscommand
import numpy as np
...
NOISES = ['data/preprocessing/noises/ambiance.wav',
          'data/preprocessing/noises/crowd.wav',
          'data/preprocessing/noises/street.wav',
          'data/preprocessing/noises/driving.wav']
